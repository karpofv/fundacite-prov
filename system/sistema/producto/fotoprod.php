                        ...
                        <div class="box box-solid box-warning">
                            ...
                            <div class="col-xs-6 box-body content-archivo">
                                <div tabindex="500" class="btn btn-primary btn-file" id="selarchivo"> <i class="glyphicon glyphicon-folder-open"><span class="">  Seleccione la imagen</span></i>
                                    <input id="archivoImage<?php echo $_POST[codigo];?>" name="archivoImage<?php echo $_POST[codigo];?>" type="file" class="file"> </div>
                                <input id="botonSubidor" type="button" class="btn btn-default" value="Actualizar" onclick="
													var inputFileImage = document.getElementById('archivoImage<?php echo $_POST[codigo];?>');
													var file = inputFileImage.files[0];
													var data = new FormData();
													data.append('archivo',file);
													var url = '<?php echo $ruta_base;?>assets/plugins/upload/upload2.php?cod=<?php echo $_POST[codigo];?>';
													$.ajax({
														url:url,
														type:'POST',
														contentType:false,
